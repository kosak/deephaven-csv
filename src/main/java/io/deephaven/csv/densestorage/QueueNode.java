...
public final class QueueNode {
    ...
    /**
     * We are a reader of 'largeArrayBuffer' in the half-open interval [largeArrayBegin, largeArrayEnd)
     * and the rest of the code promises not to change the values in that interval.
     */
    ...
    /**
     * Whether at least one reader has observed the {@link QueueNode#next} field transitioning from
     * null to non-null.
     */
