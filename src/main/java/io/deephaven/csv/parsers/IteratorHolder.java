...
public final class IteratorHolder {
    ...
    /**
     * Makes a copy of this {@link IteratorHolder}. Requires that the {@link IteratorHolder} be
     * in its initial state, i.e. that {@link IteratorHolder#tryMoveNext()} has never been called on it.
