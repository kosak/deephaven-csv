...
public abstract class CsvSpecs {
    ...
    public interface Builder {
        ...
        /**
         * Used to force a single parser for a specific column, specified by column name. Specifying a single
        ...
        /**
         * Used to force a specific set of parsers for a specific column, specified by column name.
         * If {@link #putParsersForName} and {@link #putParsersForIndex} both refer to
         * the same column, {@link #putParsersForName} takes priority.
         * 
         * @param columnName The column name
         * @param elements The parsers
         * @return self after modifying the parser property for the given columnName.
