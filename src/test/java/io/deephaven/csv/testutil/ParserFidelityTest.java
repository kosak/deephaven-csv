...
public class ParserFidelityTest {
    ...
    private static Stream<Arguments> provideTuplesForTestFidelity() {
        ...
        return Stream.of(
                ...
                // FloatFastParser will fail because Double.parseDouble yields a number on this input that is a tad larger than Float.MAX_VALUE,
                ...
                // that is a tad different from Float.parseFloat(input0
                // DoubleParser will agree with Double.parseDouble
